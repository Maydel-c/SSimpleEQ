...
void SSimpleEQAudioProcessorEditor::paint (juce::Graphics& g)
{
    ...
    // now give background, border and draw the path
...
void SSimpleEQAudioProcessorEditor::parameterValueChanged(int parameterIndex, float newValue)
{
    parametersChanged.set(true);
}

void SSimpleEQAudioProcessorEditor::timerCallback()
{
